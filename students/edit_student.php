...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '' || $email === '' || $department === '' || $year === '' || $phone === '' || $selectedCollegeId <= 0) {
        ...
        $updateStmt = $conn->prepare('UPDATE students SET college_id = ?, name = ?, email = ?, department = ?, year_level = ?, phone = ?, profile_photo = ? WHERE student_id = ?');
        ...
        try {
            ...
            $updateStmt->close();
            $errorMessage = 'Unable to update the student profile. Make sure the email address remains unique.';
        }
    }
}
...
<section class="page-heading">
    <div>
        <h1>Edit Student</h1>
        <p>Update core academic details, profile image, and contact information.</p>
    </div>
</section>
            ...
            <div class="form-grid">
                ...
                <div>
                    ...
                    <?php if (!empty($student['profile_photo'])): ?>
                        <p class="help-text">A new upload will replace the current image.</p>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <article class="insight-card">
        ...
        <div class="profile-cell">
            ...
            <div>
                ...
                <div class="muted"><?php echo e($student['department']); ?>, <?php echo e($student['year_level']); ?></div>
            </div>
        </div>
    </article>
</section>
